...
apt-get update -y && apt-get install -y apt-utils systemd && apt-get install -y gettext-base gettext openssh-client ca-certificates pkg-config wget git coreutils ed
